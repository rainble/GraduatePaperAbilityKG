package cn.edu.fudan.selab.abilitykg.Utils;
...
public class HttpRequest {
    ...
    public static <T> String sendPostInBody(String url, Map<String, T> para) {
        ...
        for (String key : para.keySet()) {
            params.add(key, para.get(key));
        }
        HttpEntity<MultiValueMap<String, T>> requestEntity = new HttpEntity<>(params, headers);
